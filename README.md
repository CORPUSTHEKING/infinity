...
[**Click here to Sponsor Infinity**](https://github.com/sponsors/CORPUSTHEKING/button")
...
The Infinity web module lives inside this repository as a contained sub-project:
 
 
- `infinity-web/index.html`
...
- Script cards and search
 
- Upload, share, request, review, report, and IWL forms
 
- Platforms and devices pages
...
The web module is static and is prepared for GitHub Pages from the repo.
